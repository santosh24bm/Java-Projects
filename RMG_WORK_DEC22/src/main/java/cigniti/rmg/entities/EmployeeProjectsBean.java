...
@Entity
@Table(name = "projects_emp_map")
public class EmployeeProjectsBean implements Serializable{

	
	private static final long serialVersionUID = -4193622466004506755L;
	...
	public String toString() {
		return "EmployeeProjectsBean [rowid=" + rowid + ", emp_id=" + emp_id + ", project_name=" + project_name
