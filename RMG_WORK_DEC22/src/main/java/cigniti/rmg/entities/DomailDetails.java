...
public class DomailDetails implements Serializable {
	

	private static final long serialVersionUID = -5743221259133721045L;
...
public String toString() {
	return "DomailDetails [rowid=" + rowid + ", employeeId=" + employeeId + ", domain_name=" + domain_name
